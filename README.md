...
- работала над созданием **"Мобильного приложения для подготовки к ЕГЭ"** с использованием инструмента Flutter для кроссплатформенной разработки. Для ознакомления перейдите по ✨[ссылке](https://ready-school.ru/)✨;
...
Сейчас нахожусь в поиске работы на должность Junior Android разработчик или стажировки в бигтехе.
